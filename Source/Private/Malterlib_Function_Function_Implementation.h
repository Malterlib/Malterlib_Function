...
namespace NMib::NFunction::NPrivate
{
	...
	protected:
		...
		only_parameters_aliased return_not_aliased inline_small void *fp_GetImpl() volatile
		{
			return m_Data.m_pImpl;
		}

		only_parameters_aliased return_not_aliased inline_small void *fp_GetImpl() const volatile
		{
			return m_Data.m_pImpl;
		}
		...
		struct TCCallRet
		{
			[[gnu::artificial]] inline_always static typename TCGetFunctionCallDefinition<t_CFOpts, t_iCall>::CType *fs_Get(TCFunctionBase volatile const *_pThis) { return _pThis->m_pVTable->template f_GetFunction<t_iCall>(); }
		};

		template <typename t_CDummmy>
		struct TCCallRet<0, t_CDummmy>
		{
			[[gnu::artificial]] inline_always static typename TCGetFunctionCallDefinition<t_CFOpts, 0>::CType *fs_Get(TCFunctionBase volatile const *_pThis) { return _pThis->m_Data.m_pCall; }
		};
	...
	protected:
		...
		only_parameters_aliased return_not_aliased inline_small void *fp_GetImpl() volatile const
		{
			return m_Data.m_pImp + 1;
		}
		...
		struct TCCallRet
		{
			[[gnu::artificial]] inline_always static typename TCGetFunctionCallDefinition<t_CFOpts, t_iCall>::CType *fs_Get(TCFunctionSmallBase volatile const *_pThis) { return _pThis->m_Data.m_pImp->m_pVTable->template f_GetFunction<t_iCall>(); }
		};

		template <mint t_iCall>
		[[gnu::artificial]] inline_always typename TCGetFunctionCallDefinition<t_CFOpts, t_iCall>::CType *fp_Call() const volatile
		{
			return TCCallRet<t_iCall>::fs_Get(this);
		}
	...
	protected:
		...
		only_parameters_aliased return_not_aliased inline_small uint8 *fp_GetImpl() volatile
		{
			return (uint8 *)m_Storage.m_Aligned;
		}

		only_parameters_aliased return_not_aliased inline_small uint8 *fp_GetImpl() const volatile
		{
			return (uint8 *)m_Storage.m_Aligned;
		}
		...
		struct TCCallRet
		{
			[[gnu::artificial]] inline_always static typename TCGetFunctionCallDefinition<t_CFOpts, t_iCall>::CType *fs_Get(TCFunctionNoAllocBase volatile const *_pThis) { return _pThis->m_pVTable->template f_GetFunction<t_iCall>(); }
		};

		template <typename t_CDummmy>
		struct TCCallRet<0, t_CDummmy>
		{
			[[gnu::artificial]] inline_always static typename TCGetFunctionCallDefinition<t_CFOpts, 0>::CType *fs_Get(TCFunctionNoAllocBase volatile const *_pThis) { return _pThis->m_pCall; }
		};
	...
	{
	public:
		[[gnu::artificial]] inline_always t_CReturn operator () (typename TCGetReferenceType<tp_CParams>::CType... p_Params) const
		{
	...
	{
	public:
		[[gnu::artificial]] inline_always t_CReturn operator () (typename TCGetReferenceType<tp_CParams>::CType... p_Params)
		{
			return this->template fp_Call<0>()(this->fp_GetImpl(), TCGetReferenceType<tp_CParams>::fs_Forward(p_Params)...);
		}
	};
	...
	{
	public:
		[[gnu::artificial]] inline_always t_CReturn operator () (typename TCGetReferenceType<tp_CParams>::CType... p_Params) volatile
		{
			return this->template fp_Call<0>()(this->fp_GetImpl(), TCGetReferenceType<tp_CParams>::fs_Forward(p_Params)...);
		}
	};
	...
	{
	public:
		[[gnu::artificial]] inline_always t_CReturn operator () (typename TCGetReferenceType<tp_CParams>::CType... p_Params) const volatile
		{
			return this->template fp_Call<0>()(this->fp_GetImpl(), TCGetReferenceType<tp_CParams>::fs_Forward(p_Params)...);
		}
	};
